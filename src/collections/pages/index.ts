...
import { Archive } from '@/features/page-builder/blocks/archive-block/config'
import { CallToAction } from '@/features/page-builder/blocks/call-to-action/config'
import { Content } from '@/features/page-builder/blocks/content/config'
import { FormBlock } from '@/features/page-builder/blocks/form/config'
import { MediaBlock } from '@/features/page-builder/blocks/media-block/config'
