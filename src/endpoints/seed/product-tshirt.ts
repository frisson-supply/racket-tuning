...
export const productTshirtData: (args: ProductArgs) => RequiredDataFromCollectionSlug<'products'> =
  ({ galleryImages, relatedProducts, metaImage, contentImage, variantTypes, categories }) => {
    return {
      enableVariants: true,
